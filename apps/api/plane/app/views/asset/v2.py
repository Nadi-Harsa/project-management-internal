...
class ProjectBulkAssetEndpoint(BaseAPIView):
    ...
    def post(self, request, slug, project_id, entity_id):
        ...
        # Scope to the project to prevent cross-project IDOR. Assets uploaded before their
        # project exists (e.g. a cover image picked in the create-project modal) have no
        # project yet, so also allow the uploader to claim their own unattached assets.
